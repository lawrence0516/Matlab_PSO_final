...
scenarios = {
    0.2, '--g', '$c_{i,1} = 0.2$', 0.99 ;  
    0.5, '-.b', '$c_{i,1} = 0.5$', 0.99 ;  
    0.8, ':k',  '$c_{i,1} = 0.8$', 0.99;  
    [],  '-r',  '$c_{i,1}\ in\ MFCPSO$',0.99  ; 
};
...
parfor s = 1:4
    ...
    [~, curve] = Gaussian_rule(jingdu, func_list(1), fhd, D, pop_size, Max_Gen, fes_max, Xmin, Xmax, fixed_c1_val, fixed_p_val, func_list(1));
