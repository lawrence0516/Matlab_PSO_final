...
for s = 1:4
    ...
    parfor r = 1:Runs
        ...
        [~, curve] = MFCPSO_func_plot(jingdu, func_num, fhd, D, pop_size, Max_Gen, fes_max, Xmin, Xmax, fixed_c1_val, fixed_p_val, func_num);
